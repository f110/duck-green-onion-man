...
<li class="input03"><span>受信箱</span>
...
<option value="body" >本文＆件名</option>
<option value="subject" >件名のみ</option>
<option value="nickname" id="nicknameoption" >差出人</option>

</select></li>
<li><input type="image" src="http://img.mixi.net/img/basic/button/search003.gif" alt="検索" class="inputImage" /></li>
</ul>
</form>
</div>
<!-- 検索 メッセージ -->
...
<div class="pageTitle homeTitle005"><h2>Iの受信箱</h2></div>
...
<ul><li rel="__display">1件〜20件を表示</li><li rel="__next"><a href="list_message.pl?page=2&box=inbox">次を表示</a></li></ul>
</div>
...
<tr class="top ">
<td class="status"><input name="message_id" type="checkbox" value="" /><img src="http://img.mixi.net/img/basic/icon/message_opened.gif" alt="開封済み" /></td>
<td class="sender">doctor who</td>
<td class="subject"><a href="view_message.pl?id=11234567890&box=inbox&page=1">☆mixi Xmasへの招待☆</a></td>
<td class="date">12月10日<a id="message_1234567890" class='delete_message_link' href="javascript:void(0);" ><img src="http://img.mixi.net/img/basic/icon/message_trash002.gif" alt="削除" title="削除" /></a></td>
</tr>

<tr class="">
<td class="status"><input name="message_id" type="checkbox" value="1234567890" /><img src="http://img.mixi.net/img/basic/icon/message_opened.gif" alt="開封済み" /></td>
<td class="sender">Catharine</td>
<td class="subject"><a href="view_message.pl?id=21234567890&box=inbox&page=1">友人追加リクエスト</a></td>
<td class="date">10月19日<a id="message_1234567890" class='delete_message_link' href="javascript:void(0);" ><img src="http://img.mixi.net/img/basic/icon/message_trash002.gif" alt="削除" title="削除" /></a></td>
</tr>
...
<input type="submit" class="formBt01" value="削除" /></p>
...
<p class="moreLink01" style="padding-right:10px;"><a href="edit_message_setting.pl">受信範囲の設定</a></p>
